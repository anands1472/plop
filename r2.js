...
function createFolders(folderName, subfolderName = '') {
    ...
    const folderPath = subfolderName ? path.join(hooksFolderPath, folderName, subfolderName) : path.join(hooksFolderPath, folderName);
    ...
    rl.question("Enter the Gateway API URL: ", (gatewayApiUrl) => {
        rl.question("Enter the Microservices API URL: ", (microservicesApiUrl) => {
            ...
            const gatewayKey = subfolderName ? `${folderName}${capitalizeFirstLetter(subfolderName)}GatewayApiUri` : `${folderName}GatewayApiUri`;
            const microservicesKey = subfolderName ? `${folderName}${capitalizeFirstLetter(subfolderName)}MicroservicesApiUri` : `${folderName}MicroservicesApiUri`;
...
`;
            ...
            console.log(`✅ 'appUriConfig.js' updated with new URIs for '${folderName}${subfolderName ? '/' + subfolderName : ''}'.`);
...
export default ${subfolderName ? subfolderName : folderName}Route;`;
            ...
            console.log(`✅ Created request, response, and router files inside 'hooks/${folderName}${subfolderName ? '/' + subfolderName : ''}' and 'routes/'.`);
